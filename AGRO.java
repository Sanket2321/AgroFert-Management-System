...
//		header.add(name);
		...
		login.setBounds(550,250,450,350);
      ...
      public void actionPerformed(ActionEvent e)
	  {
		...
		for(char x:pass)
			pwd+=x;
          if((username.equals("sanketsonawane")) && (pwd.equals("1234"))) 
		  {
            new home();
			dispose();
          } 
		...
		t3.addFocusListener(new FocusAdapter()
			{
				public void focusLost(FocusEvent fe)
				{
					...
					try
					{
						...
						con=DriverManager.getConnection("jdbc:mysql://localhost:3306/xyz","root","1234"); 
						Class.forName("com.mysql.jdbc.Driver");
